...
If you DON'T want a recovery email added to the account when it is created go to `config.js?plain=2` file and set ADD_RECOVERY_EMAIL (default: true) to false.
> (Not recommended).
